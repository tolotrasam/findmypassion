...
echo '<div class="wrapfeed"><img class = "feedpicture" width="40px" height="40px" src="http://chasingafterme.com/wp-content/uploads/2012/06/Community.jpg">';
...
echo '<div class= "cuttertext"><p>'.$post.'</p></div></div>';
echo '<div class = "image-feed-div"><img class = "image-feed" id = "image-'.$feed_code.'"src="'.$imagepath.' " alt="'.$imagename.'" style="width: 100% ;" onerror="this.style.display=\'none\'"></img></div>';
// echo $feed_code;
